...
use crate::domain::{
    editor::{
        EditorDomainService, QueryExecutionContext, SqlExecutor, SqlQuery, SqlQueryRepository,
    },
    shared::{DatabaseId, DomainResult, PagedResult, Pagination, QueryId},
};
...
impl EditorApplicationService for EditorApplicationServiceImpl {
    ...
    async fn execute_query(
        ...
        let result = self
            .domain_service
            .execute_query(&query_id, context)
            .await?;
